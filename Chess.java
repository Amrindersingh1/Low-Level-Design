...
*	3. randomly assign starting pieces
*	4. no undo/rollbacks
*	5. each player make moves alternatively. white starts first.
*	6. Log all moves
*	7. Game finish : checkmate, draw or forfeit
*/

/* Actors:
*	1. Players : make move, forfeit, manage account
*	2. Admin : manage players
*/
...
public enum GameStatus {
  ACTIVE, BLACK_WIN, WHITE_WIN, FORFEIT
}
